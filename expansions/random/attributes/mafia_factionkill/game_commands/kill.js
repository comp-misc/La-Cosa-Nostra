...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    game.getChannel("mafia").send("| :dagger: |  **" + from.getDisplayName() + "** has selected the factional kill not to be used tonight.");
    return null;
  };
  ...
  game.getChannel("mafia").send("| :dagger: |  **" + from.getDisplayName() + "** is using the factional kill on **" + mention + "** tonight.");
