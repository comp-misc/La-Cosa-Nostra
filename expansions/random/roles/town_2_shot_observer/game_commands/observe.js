...
module.exports = function (game, message, params) {
  ...
  if (from.misc.observer_observes_left < 1) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && x.identifier === "town_2_shot_observer/observe");
  ...
  if (to.id === message.author.id) {
    ...
    game.addAction("town_2_shot_observer/observe", ["cycle"], {
