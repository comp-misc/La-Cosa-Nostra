...
module.exports = function (game, message, params) {
  ...
  if (game.getPeriod() % 4 !== 1) {
    message.channel.send(":x:  You may only visit on odd nights!");
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && (x.identifier === "town_odd_night_vote_influencer/influence" || x.identifier === "town_odd_night_vote_influencer/block"));
  ...
  game.addAction("town_odd_night_vote_influencer/influence", ["cycle"], {
