		...
		if (mafia_lawyer.length > 0) {
			...
			for (var i = 0; i < visit_log.length; i++) {
				if (visit_log[i].target === actionable.to) {
					...
					if (
						visitor.role_identifier === "mafia_lawyer" ||
						visitor.role_identifier === "mafia_1_shot_lawyer" ||
						visitor.role_identifier === "mafia_2_shot_lawyer" ||
						visitor.role_identifier === "mafia_odd_night_lawyer" ||
						visitor.role_identifier === "mafia_even_night_lawyer" ||
						visitor.role_identifier === "mafia_nonconsecutive_lawyer"
					) {
