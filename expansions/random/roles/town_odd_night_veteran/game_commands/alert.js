...
module.exports = function (game, message, params) {
  ...
  if (game.getPeriod() % 4 !== 1) {
    message.channel.send(":x:  You may only be alert on odd nights!");
  ...
  var already_alerting = actions.exists(x => x.from === from.identifier && x.identifier === "town_odd_night_veteran/alert");
  ...
  game.addAction("town_odd_night_veteran/alert", ["cycle"], {
    name: "Veteran-alert",
    expiry: 1,
