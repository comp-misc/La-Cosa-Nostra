...
module.exports = function (actionable, game, params) {
  ...
  game.addAction("mafia_nonconsecutive_poisoner/poison_kill", ["cycle"], {
    name: "Poison-kill",
    expiry: 3,
    execution: 3,
    ...
    if (doctor.length > 0) {
      ...
      for (var i = 0; i < visit_log.length; i++) {
        if (visit_log[i].target === actionable.to) {
          ...
          if (visitor.role_identifier === "town_doctor" || visitor.role_identifier === "town_1_shot_doctor" || visitor.role_identifier === "town_2_shot_doctor" ||visitor.role_identifier === "town_odd_night_doctor" ||visitor.role_identifier === "town_even_night_doctor" ||visitor.role_identifier === "town_nonconsecutive_doctor" || visitor.role_identifier === "mafia_doctor" || visitor.role_identifier === "mafia_1_shot_doctor" || visitor.role_identifier === "mafia_2_shot_doctor" ||visitor.role_identifier === "mafia_odd_night_doctor" ||visitor.role_identifier === "mafia_even_night_doctor" ||visitor.role_identifier === "mafia_nonconsecutive_doctor") {
            return true
          };
        };
