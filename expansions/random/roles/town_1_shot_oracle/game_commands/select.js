...
module.exports = function (game, message, params) {
  ...
  if (from.misc.oracle_selects_left < 1) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && x.identifier === "town_1_shot_oracle/select");
  ...
  if (to.id === message.author.id) {
    ...
    game.addAction("town_1_shot_oracle/select", ["cycle"], {
      name: "Oracle-choose",
      expiry: 1,
