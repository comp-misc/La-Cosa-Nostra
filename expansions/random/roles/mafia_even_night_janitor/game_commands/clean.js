...
module.exports = function (game, message, params) {
  ...
  if (game.getPeriod() % 4 !== 3) {
    message.channel.send(":x:  You may only clean the body of a dead player on even nights!");
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => (x.from === from.identifier && x.identifier === "mafia_even_night_janitor/clean"));
  ...
  game.addAction("mafia_even_night_janitor/clean", ["cycle"], {
    name: "Janitor-clean",
    expiry: 1,
