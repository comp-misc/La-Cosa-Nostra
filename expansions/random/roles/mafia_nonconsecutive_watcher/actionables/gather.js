...
module.exports = function (actionable, game, params) {
	...
	if (visitor_names.length > 0) {
		var message = ":telescope:  " + auxils.pettyFormat(visitor_names) + " visited your target last night."

		game.addMessage(lookout, message)
	} else {
		game.addMessage(lookout, ":telescope:  Your target was not visited by anyone last night.")
	}
}