...
module.exports = function (actionable, game, params) {
  ...
  // Check if exists
  var investigating = game.actions.exists(x => x.from === player.identifier && (x.identifier === "mafia_1_shot_vote_influencer/influence" || x.identifier === "mafia_1_shot_vote_influencer/block"));
