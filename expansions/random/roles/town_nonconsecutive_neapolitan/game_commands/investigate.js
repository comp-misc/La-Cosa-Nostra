...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && (x.identifier === "town_nonconsecutive_neapolitan/investigate" || x.identifier === "town_nonconsecutive_neapolitan/no_action"));

    game.addAction("town_nonconsecutive_neapolitan/no_action", ["cycle"], {
      name: "SE-no_action",
      expiry: 1,
  ...
  if (to.id === message.author.id) {
    ...
    game.addAction("town_nonconsecutive_neapolitan/investigate", ["cycle"], {
