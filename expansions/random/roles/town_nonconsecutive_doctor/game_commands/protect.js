...
module.exports = function (game, message, params) {
	...
	if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
		actions.delete(
			(x) =>
				...
				(x.identifier === "town_nonconsecutive_doctor/protect" ||
					x.identifier === "town_nonconsecutive_doctor/no_action")
		)
	...
	actions.delete(
		(x) =>
			x.from === from.identifier &&
			(x.identifier === "town_nonconsecutive_doctor/protect" || x.identifier === "town_nonconsecutive_doctor/no_action")
	)
