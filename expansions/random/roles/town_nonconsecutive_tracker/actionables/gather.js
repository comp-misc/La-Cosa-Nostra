...
module.exports = function (actionable, game, params) {
	...
	if (visited_names.length > 0) {
		var message = ":mag_right:  Your target visited " + auxils.pettyFormat(visited_names) + " last night."

		game.addMessage(tracker, message)
	} else {
		game.addMessage(tracker, ":mag_right:  Your target did not visit anyone last night.")
	}
}
