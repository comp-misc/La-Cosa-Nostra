...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && (x.identifier === "mafia_nonconsecutive_vote_influencer/influence" || x.identifier === "mafia_nonconsecutive_vote_influencer/block" || x.identifier === "mafia_nonconsecutive_vote_influencer/no_action"));
