...
module.exports = function (player) {
  ...
  player.game.addAction("mafia_nonconsecutive_vote_influencer/no_action", ["cycle"], {
    name: "SE-no_action",
    expiry: 1,
    from: player,
    to: player
  ...
  if (player.misc.consecutive_night === false) {
    ...
    player.game.sendPeriodPin(channel, ":bookmark:  You may not influence or block the vote of someone before next night.");
  };
