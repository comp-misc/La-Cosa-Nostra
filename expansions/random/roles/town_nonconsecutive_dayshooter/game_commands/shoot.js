...
module.exports = function (game, message, params) {
  ...
  if (from.misc.consecutive_day === true) {
    message.channel.send(":x:  You may not use an action on two consecutive days!");
  ...
  if (to.id === message.author.id) {
    ...
    actions.delete(x => x.from === from.identifier && x.identifier === "town_nonconsecutive_dayshooter/no_action");

    game.addAction("town_nonconsecutive_dayshooter/shoot", ["instant"], {
