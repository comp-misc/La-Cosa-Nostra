...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && (x.identifier === "mafia_even_night_vote_influencer/influence" || x.identifier === "mafia_even_night_vote_influencer/block"));
  ...
  game.addAction("mafia_even_night_vote_influencer/block", ["cycle"], {
    name: "SE-block",
    expiry: 1,
