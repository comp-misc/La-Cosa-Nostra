...
module.exports = function (actionable, game, params) {
  ...
  // Check if exists
  var investigating = game.actions.exists(x => x.from === player.identifier && (x.identifier === "mafia_even_night_vote_influencer/influence" || x.identifier === "mafia_even_night_vote_influencer/block"));
