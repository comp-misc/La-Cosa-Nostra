...
module.exports = function (player) {
  ...
  if (player.misc.janitor_cleans_left > 0) {
    ...
    player.game.sendPeriodPin(channel, ":drop_of_blood:  You may clean a player tonight. You have **" + player.misc.janitor_cleans_left + "** clean" + auxils.vocab("s", player.misc.janitor_cleans_left) + " left.\n\nUse `" + config["command-prefix"] + "clean <alphabet/name/nobody>` to select your target.");
