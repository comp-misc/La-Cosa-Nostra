...
module.exports = function (player) {
  ...
  if (player.misc.oracle_selects_left > 0) {
    ...
    player.game.sendPeriodPin(channel, ":pen_fountain:  You may select a player tonight.\n\nYou have **" + player.misc.oracle_selects_left + "** select" + auxils.vocab("s", player.misc.oracle_selects_left) + " left.\n\nUse `" + config["command-prefix"] + "select <alphabet/name/nobody>` to select your target.\n\n" + addendum);
