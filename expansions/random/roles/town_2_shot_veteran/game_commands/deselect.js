...
module.exports = function (game, message, params) {
  ...
  var already_alerting = actions.exists(x => x.from === from.identifier && x.identifier === "town_2_shot_veteran/alert");
  ...
  actions.delete(x => x.from === from.identifier && x.identifier === "town_2_shot_veteran/alert");
