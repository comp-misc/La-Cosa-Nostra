...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && x.identifier === "mafia_tracker/track");
  ...
  game.getChannel("mafia").send(":mag_right:  **" + from.getDisplayName() + "** is tracking **" + mention + "** tonight.");
