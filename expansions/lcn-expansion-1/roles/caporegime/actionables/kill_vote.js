...
module.exports = function (actionable, game, params) {
  ...
  because of a role assignation problem.*/
	...
	var mafioso = game.find(
		(x) => x.role_identifier === "mafioso" && x.isAlive() && !x.getStatus("roleblocked") && !x.getStatus("kidnapped")
	)
	...
	if (mafioso) {
		...
		game.addMessage(
			mafioso,
			":exclamation: The __Caporegime__ has ordered you to attack his target, **" + to.getDisplayName() + "**."
		)
	} else {
