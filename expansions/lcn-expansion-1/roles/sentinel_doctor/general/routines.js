...
module.exports = function (player) {
	...
	if (target && target.isAlive()) {
		player.game.sendPeriodPin(
			channel,
			":pill: Your current target is **" +
				target.getDisplayName() +
				"**. You will repeatedly protect them until they die, in which case you may choose a new target."
		)
		...
		player.game.sendPeriodPin(
			channel,
			":pill: You may choose a player to repeatedly heal.\n\nUse `" +
