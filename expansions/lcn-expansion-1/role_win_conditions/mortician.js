...
module.exports = function (game) {
	...
	var mafia_win_check =
		!game.checkRoles(mafia_win_condition.ELIMINATED) && game.checkRoles(mafia_win_condition.SURVIVING)
...
module.exports.DESCRIPTION =
	"Survive to the end of the game. If the Mafia wins, you will steal the kill from them. If the Town wins, you win with them if you are still alive. Any other Neutral solo wins will lead to your loss."
