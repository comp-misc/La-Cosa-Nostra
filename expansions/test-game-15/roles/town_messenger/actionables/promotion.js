...
module.exports = function (actionable, game, params) {
  ...
  if (prime_minister.length == 0) {
    game.addMessage(player, ":exclamation: You were demoted to a __Vanilla Townie__.\n\nAs a result of the death of the " + var_president + " you lost all your actions!");
  };

  if (president.length == 0) {
    game.addMessage(player, ":exclamation: You were demoted to a __Vanilla Townie__.\n\nAs a result of the death of the " + var_prime_minister + " you lost all your actions!");
  };

  if (president.length > 0 && prime_minister.length > 0) {
    game.addMessage(player, ":exclamation: You were demoted to a __Vanilla Townie__.\n\nAs a result of the death of the " + var_president + " and " + var_prime_minister + " you lost all your actions!");
  };

  player.changeRole("town_vanilla_townie");
