...
module.exports = function (player) {
  ...
  var available1 = game.findAll(x => x.role_identifier === "town_neighbour" && x.isAlive() && x.identifier !== player.identifier && !x.misc.paired);
  var available2 = game.findAll(x => x.role_identifier === "mafia_neighbour" && x.isAlive() && x.identifier !== player.identifier && !x.misc.paired);
