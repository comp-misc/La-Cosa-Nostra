...
module.exports = function (game, message, params) {
	...
	if (from.misc.roleblocks_left < 1) {
		message.channel.send(":x: You do not have any roleblocks left!")
		return null
	}
	...
	if (to.id === message.author.id) {
		...
		game.addAction("one_shot_roleblocker/roleblock", ["cycle"], {
			name: "1-Shot Roleblocker-roleblock",
			expiry: 1,
