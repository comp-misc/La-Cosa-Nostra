...
var usable_powers = Object.values(attributes).filter(
...
module.exports = function (game, message, params) {
	...
	if (params.length < 1) {
		message.channel.send(
			":mag: You have decided not to use a power census tonight. Please use `" +
				config["command-prefix"] +
				"powercensus [power]` if you decide otherwise."
		)
		return null
	}
