...
module.exports = function (actionable, game, params) {
	...
	if (target.isAlive()) {
		...
		game.addMessage(
			target,
			":exclamation: You have recruited into the Cult by **" +
				mentor.getDisplayName() +
				"**. In order to win, you must now survive to see the Cult reach parity and eliminate all threats to itself."
		)
		game.addMessage(
			mentor,
			":exclamation: You have recruited your target, **" + target.getDisplayName() + "**, into the Cult."
		)
	} else {
