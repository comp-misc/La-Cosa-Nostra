...
module.exports = function (game, message, params) {
	...
	if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
		message.channel.send(":gun: You have decided not to kill anyone tonight.")
		return null
	}
	...
	if (to.id === message.author.id) {
		...
		game.addAction("a/power_kill/kill", ["cycle"], {
			name: "Modular-kill",
			expiry: 1,
			priority: 5,
	...
	message.channel.send(":gun: You have decided to kill **" + mention + "** tonight.")
}
