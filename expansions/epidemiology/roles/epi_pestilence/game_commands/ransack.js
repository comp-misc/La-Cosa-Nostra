...
module.exports = function (game, message, params) {
	...
	if (params[0] === undefined) {
		message.channel.send(
			":x: Wrong syntax! Please use `" + config["command-prefix"] + "ransack <alphabet/username/nobody>` instead!"
		)
		return null
	}
	...
	actions.delete(
		(x) =>
			...
			(x.identifier === "epi_pestilence/ransack" || x.identifier === "epi_pestilence/self_ransack")
	)
