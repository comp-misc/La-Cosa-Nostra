...
module.exports = function (actionable, game, params) {
	...
	var blessings = game.actions.delete((x) => x.identifier === "a/blessing_vigour/bless" && x.to === actionable.to)

	if (blessings.length > 1) {
		// Use the blessing
		game.addAction("a/blessing_vigour/influence", ["cycle"], {
			name: "Modular-double-vote-blessing",
			priority: 1,
			expiry: 2,
