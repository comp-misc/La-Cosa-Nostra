...
module.exports = function (actionable, game, params) {
	...
	var contractor = game.getPlayerByIdentifier(
		player.attributes.find((x) => x.identifier === "investigation_contract").tags.contractor
	)

	// Check if exists
	var investigating = game.actions.exists(
		(x) => x.from === player.identifier && x.identifier === "a/investigation_contract/investigate"
	)
