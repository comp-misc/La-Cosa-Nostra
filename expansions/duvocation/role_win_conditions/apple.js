...
module.exports = function (game) {
	...
	var delta = apple_followers - orange_followers

	if (delta > 0) {
		var winners = game.findAll((x) => x.role_identifier === "demigod_apple" && x.canWin())
...
module.exports.DESCRIPTION = "Gain more followers than the Demigod of Orange Juice."
