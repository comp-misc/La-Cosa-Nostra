...
module.exports = function (actionable, game, params) {
	...
	var followers = game
		...
		.filter(
			(x) =>
				x.role_identifier === "follower_of_3" &&
				rs.modular.hasModule(x, "blessing_restraint") &&
				rs.modular.hasModule(x, "blessing_security") &&
				rs.modular.hasModule(x, "blessing_vigour")
		)
	...
	steal_loop: for (var i = 0; i < stealable.length; i++) {
