...
module.exports = function (player) {
	...
	player.addIntroMessage(
		":candle: This is a modular set-up. This is a directory for modular commands:\n\n:one: `" +
			prefix +
			"curse`: lists all available modular curses.\n:two: `" +
			prefix +
			"curse <curse name>`: provides the information associated with a modular curse.\n:three: `" +
			prefix +
			"listcurses`: lists all the curses you have at the time of execution. \n\nThese commands may only be run in your private channel."
	)
