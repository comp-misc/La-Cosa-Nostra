...
module.exports = function (actionable, game, params) {
  ...
  // Check if exists
  var tracking = game.actions.exists(x => x.from === player.identifier && x.identifier === "mafia_1_shot_tracker/track");
  var previously_roleblocked = player.getStatus("roleblocked");

  if (tracking && !previously_roleblocked) {
    game.addMessage(player, ":mag: You got __No Result__.\n\nYour action was blocked last night. It was not consumed.");
  };
