...
module.exports = function (player) {
  ...
  if (player.misc.roleblocker_roleblocks_left > 0) {
    ...
    player.game.sendPeriodPin(channel, ":no_entry_sign:  You may roleblock a player tonight.\n\nYou have " + player.misc.roleblocker_roleblocks_left + " roleblock" + auxils.vocab("s", player.misc.roleblocker_roleblocks_left) + " left.\n\nUse `" + config["command-prefix"] + "roleblock <alphabet/name/nobody>` to select your target.");
