...
module.exports = function (game, message, params) {
  ...
  if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
    ...
    actions.delete(x => x.from === from.identifier && (x.identifier === "3p_haunted_jester/haunt" || x.identifier === "3p_haunted_jester/random_haunt"));

    message.channel.send(":ghost:  You have now selected to not haunt anyone. A player who has lynched you will be haunted at random.");
