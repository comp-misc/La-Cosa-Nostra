...
module.exports = function (player) {
  ...
  var available = game.findAll(x => x.role_identifier === "mafia_neighbour" && x.isAlive() && x.identifier !== player.identifier && !x.misc.paired);
  //available = available.concat(game.findAll(x => x.role_identifier === "mafia_neighbour" && x.isAlive() && x.identifier !== player.identifier && !x.misc.paired));
