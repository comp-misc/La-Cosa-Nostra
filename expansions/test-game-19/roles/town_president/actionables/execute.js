...
module.exports = function (actionable, game, params) {
  ...
  rs.prototypes.unstoppableAttack.reason = "executed by the __President__";
  ...
  main_channel.send(":crossed_swords:  **" + target.getDisplayName() + "** was executed by the _President__.");
