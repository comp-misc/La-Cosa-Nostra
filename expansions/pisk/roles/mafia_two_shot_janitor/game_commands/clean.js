...
module.exports = function (game, message, params) {
	...
	actions.delete((x) => x.from === from.identifier && x.identifier === "mafia_two_shot_janitor/clean")
	...
	game.addAction("mafia_two_shot_janitor/clean", ["cycle"], {
		name: "Janitor-clean",
		expiry: 1,
	...
	game
		...
		.send(
			":exclamation: **" +
				...
				"** is cleaning **" +
				mention +
				"** tonight. The factional kill may be used in addition to the clean action, and should be submitted separately."
		)
}
