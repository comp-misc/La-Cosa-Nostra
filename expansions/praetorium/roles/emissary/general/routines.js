...
module.exports = function (player) {
	...
	player.game.sendPeriodPin(
		channel,
		":envelope_with_arrow: You may impart with a member of the Praetorium tonight to engage in secret communication.\n\nUse `" +
			config["command-prefix"] +
			"impart <alphabet/name/nobody>` to select your target.\nThis action is irreversible and will fail if the target selected is not a recruited member of the Praetorium."
	)
}
