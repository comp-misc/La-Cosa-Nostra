...
module.exports = function (player) {
  ...
  if (player.misc.toxicologist_poisons_left > 0) {
    ...
    player.game.sendPeriodPin(channel, ":syringe: You may choose to poison a player tonight.\n\nYou have __" + player.misc.toxicologist_poisons_left + "__ poison" + auxils.vocab("s", player.misc.toxicologist_poisons_left) + " left.\n\nUse `" + config["command-prefix"] + "poison <alphabet/name/nobody>` to select your target.");
