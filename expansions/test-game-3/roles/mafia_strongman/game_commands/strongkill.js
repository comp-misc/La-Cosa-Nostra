...
module.exports = function (game, message, params) {
	...
	if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
		...
		game
			.getChannel("mafia")
			.send(":exclamation: **" + from.getDisplayName() + "** is not strongkilling anybody tonight.")
		return null
	}
	...
	game
		.getChannel("mafia")
		.send(":exclamation: **" + from.getDisplayName() + "** is using a strongkill on **" + mention + "** tonight.")
}
