...
module.exports = function (game, message, params) {
	...
	var already_commuting = actions.exists((x) => x.from === from.identifier && x.identifier === "town_commuter/commute")
	...
	actions.delete((x) => x.from === from.identifier && x.identifier === "town_commuter/commute")
