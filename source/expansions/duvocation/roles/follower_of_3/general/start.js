...
module.exports = function (player) {
	...
	player.addIntroMessage(
		":pray: This is a modular set-up. This is a directory for modular commands:\n\n:one: `" +
			prefix +
			"blessing`: lists all available modular blessings.\n:two: `" +
			prefix +
			"blessing <blessing name>`: provides the information associated with a modular blessing.\n:three: `" +
			prefix +
			"listblessings`: lists all the blessings you have at the time of execution.\n\nThese commands may only be run in your private channel."
	)
}