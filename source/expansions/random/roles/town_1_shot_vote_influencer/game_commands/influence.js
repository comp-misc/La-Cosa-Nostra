...
module.exports = function (game, message, params) {
	...
	if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
		actions.delete(
			(x) =>
				...
				(x.identifier === "town_1_shot_vote_influencer/influence" ||
					x.identifier === "town_1_shot_vote_influencer/block")
		)
	...
	actions.delete(
		(x) =>
			x.from === from.identifier &&
			(x.identifier === "town_1_shot_vote_influencer/influence" || x.identifier === "town_1_shot_vote_influencer/block")
	)

	game.addAction("town_1_shot_vote_influencer/influence", ["cycle"], {
