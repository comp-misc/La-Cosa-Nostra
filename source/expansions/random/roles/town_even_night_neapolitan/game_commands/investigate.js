...
module.exports = function (game, message, params) {
	...
	if (to.score < 0.7 || params[0].toLowerCase() === "nobody") {
		actions.delete((x) => x.from === from.identifier && x.identifier === "town_even_night_neapolitan/investigate")
	...
	if (to.id === message.author.id) {
		...
		game.addAction("town_even_night_neapolitan/investigate", ["cycle"], {
