...
export default class StrongKill extends TargetableRolePart<TargetableRoleConfig, TargetableRoleState> {
	...
	formatDescriptor(descriptor: RoleDescriptor): void {
		descriptor.addDescription(BasicDescriptionCategory.ROLE_ABILITIES, {
			name: "Strong Kill",
			description: super.formatPeriodDescription() + ", you may choose to strong kill a player",
