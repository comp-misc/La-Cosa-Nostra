...
const DESCRIPTION = `
Welcome to \${game.name}! You are a Town Roleblocker.

Role Abilities:
- Each night, you may choose to roleblock a player to block them from performing any night actions\${cooldownDescription}. This action cannot be roleblocked.

Win Condition: You win when all threats to town have been eliminated and there is at least one member of town left.
`.trim()

export default class TownRoleblocker implements ProgrammableRole<ConsecutiveTargetConfig> {
