...
module.exports = function (game) {
	...
	var pestilence = game.findAll(
		(x) => (x.role_identifier === "epi_pestilence" || x.role_identifier === "epi_plaguebearer") && x.isAlive()
	)
...
module.exports.SURVIVING = [(x) => x.role_identifier === "epi_plaguebearer" || x.role_identifier === "epi_pestilence"]
