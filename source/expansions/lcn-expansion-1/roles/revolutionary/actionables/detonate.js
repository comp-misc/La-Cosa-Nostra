...
module.exports = function (actionable, game, params) {
	...
	if (
		message.channel.id !== game.getMainChannel().id &&
		message.channel.id !== (game.getWhisperLogChannel() || new Object()).id
	) {
		return false
	}
	...
	game.actions.delete(
		(x) => x.identifier === "revolutionary/defused_message" && x.from === actionable.from && x.to === actionable.to
	)
