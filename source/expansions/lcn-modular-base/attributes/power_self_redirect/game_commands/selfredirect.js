...
module.exports = function (game, message, params) {
	...
	if (params[0] === undefined) {
		message.channel.send(
			":x: Wrong syntax! Please use `" + config["command-prefix"] + "selfredirect <alphabet/username/nobody>` instead!"
		)
		return null
	}
	...
	message.channel.send(
		":leftwards_arrow_with_hook: You have decided to redirect all actions on **" + mention + "** to yourself tonight."
	)
}
