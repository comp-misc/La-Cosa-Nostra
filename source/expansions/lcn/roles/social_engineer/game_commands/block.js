...
module.exports = function (game, message, params) {
	...
	actions.delete(
		(x) =>
			...
			(x.identifier === "social_engineer/influence" ||
				x.identifier === "social_engineer/block" ||
				x.identifier === "social_engineer/no_action")
	)
	...
	game.addAction("social_engineer/block", ["cycle"], {
		name: "SE-block",
		expiry: 1,
		from,
		to,
