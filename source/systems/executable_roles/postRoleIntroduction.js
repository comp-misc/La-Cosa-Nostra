...
module.exports = async function (player, stagger = 400) {
	...
	send = send.replace(
		/{;description}/g,
		flavour_role["secondary-description"] || flavour_role["description"] || role["description"]
	)
	...
	var start_message = await channel.send(
		"~~                                              ~~    **" +
			player.game.getFormattedDay() +
			"**         [*game start*]"
	)
